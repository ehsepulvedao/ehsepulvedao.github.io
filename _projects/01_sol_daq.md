...
<div class="row justify-content-center">
  <div class="col-sm-10 mt-3 mt-md-0">
    ...
    loading="eager"
    path="assets/img/projects/sol_daq_architecture.png"
    title="SOL-DAQ Architecture"
    class="img-fluid rounded z-depth-1" %}
  </div>
</div>

<div class="caption">
Global architecture of the SOL-DAQ platform, from data acquisition and transmission to preprocessing, fault detection, diagnosis and decision support.
</div>

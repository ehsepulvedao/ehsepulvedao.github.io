...
<div class="row justify-content-center">
  <div class="col-sm-10 mt-3 mt-md-0">
    ...
    loading="eager"
    path="assets/img/projects/infinity_methodology.png"
    title="INFINITY Methodology"
    class="img-fluid rounded z-depth-1" %}
  </div>
</div>

<div class="caption">
Conceptual workflow of the INFINITY project, from IoT sensor deployment and signal acquisition to intelligent diagnosis, coherence analysis and experimental validation.
</div>

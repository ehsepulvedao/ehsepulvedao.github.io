...
<div class="row justify-content-center">
  <div class="col-sm-10 mt-3 mt-md-0">
    ...
    loading="eager"
    path="assets/img/projects/statechart_neonatal_model.png"
    title="Statechart Model for Neonatal Adaptation"
    class="img-fluid rounded z-depth-1" %}
  </div>
</div>

<div class="caption">
Formal statechart representation of immediate neonatal adaptation guidelines, including patient states, clinical events and decision transitions.
</div>

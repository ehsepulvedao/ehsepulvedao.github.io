...
<div class="row justify-content-center">
  <div class="col-sm-10 mt-3 mt-md-0">
    ...
    loading="eager"
    path="assets/img/projects/neonatal_model_architecture.png"
    title="Cardiovascular and Respiratory Neonatal Model"
    class="img-fluid rounded z-depth-1" %}
  </div>
</div>

<div class="caption">
Integrated cardiovascular-respiratory model of neonatal physiology including blood circulation, gas transport and oxygen exchange mechanisms.
</div>
